...
mongoose.connect("mongodb+srv://sankhlarakesh4321:Rakesh4321@cluster0.xx63jxo.mongodb.net/todolistDB" , {useNewUrlParser : true});
...
app.post("/delete" ,function(req,res){
    ...
    if(listName === "Today"){
        ...
        List.findOneAndUpdate( {name:listName} ,{$pull :{items :{_id : checkedItemId}}}).catch((err) => console.log(err));
        res.redirect("/" + listName);
    }
